...
function CheckAuthentication()
{
	...
	// we can return directly "true" because only admin is permitted to access ckfinder from administration.
	return true;
	return false;
}
...
//$baseUrl = dirname($_SERVER['SCRIPT_NAME']) . '/userfiles/';
$baseUrl = '/' . str_replace($_SERVER['DOCUMENT_ROOT'], '', str_replace('\\', '/', __DIR__ . '/userfiles/'));
//$baseUrl = '/userfiles/';
